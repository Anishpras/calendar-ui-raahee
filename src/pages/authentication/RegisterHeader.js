...
function RegisterHeader() {
  ...
  return (
    <div>
      <img src="" className="header__bg" alt="background"></img>
        ...
        <Container fluid>
          <Row>
            <Col xs={12} md={6} className="header__left">
              <center>
                <Link to="/">
                  <img src="" alt="FAMista Logo" className="header__logo"></img>
                </Link>
              </center>
            </Col>
            <Col xs={12} md={6} className="d-none d-md-block header__right">
              ...
              <center>
                {error && (
                  <Alert className="w-75 text-center mt-3" variant="danger">
                    {error}
                  </Alert>
                )}
              </center>
